...
CROSSOVER = ["xalt_edges",'xpmx','x_orderx'];  % omitted 'uhx' because that's meant just for path representation
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
MutationMethode=["inversion",'reciprocal_exchange','scramble','insert'];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
