...
ELITIST=[0.01, 0.05, 0.1];    % percentage of the elite population
GGAP=1-ELITIST;		% Generation gap
STOP_PERCENTAGE=0.90;    % percentage of equal fitness individuals for stopping
PR_CROSS=[0.70, 0.65, 0.15];     % probability of crossover
PR_MUT=[0.15, 0.3, 0.70];       % probability of mutation
LOCALLOOP=[1];      % local loop removal
CROSSOVER = ["xalt_edges",'xpmx','x_orderx'];  % omitted 'uhx' because that belongs to Task 4
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
MutationMethode=["inversion",'reciprocal_exchange','scramble','insert', 'swapping'];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
writetable(result,'results_ParameterTuning_Task3_path.csv')
