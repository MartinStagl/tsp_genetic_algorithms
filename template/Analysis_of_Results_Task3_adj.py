...
result = pd.read_csv('results_ParameterTuning_Task3_adj.csv')

# parameters
crossover = ['xalt_edges', 'xpmx', 'x_orderx']
pr_cross = [0.7, 0.65, 0.15]
mutation = ['inversion', 'reciprocal_exchange', 'scramble', 'insert']
pr_mut = [0.15, 0.3, 0.7]
