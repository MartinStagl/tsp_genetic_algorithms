...
%Added additional parameter for heuristics:
%   Dist       - Distance Matrix for heuristic crossover

function NewChrom = recombin_heuristic(REC_F, Chrom, RecOpt,Dist);
...
% Select individuals of one subpopulation and call low level function
   ...
   for irun = 1:SUBPOP,
      ...
      NewChromSub = feval(REC_F, ChromSub, Dist);
